...
// bonus's tree, when several bonuses are edited side by side (BonusGroups.vue, one item's
// "Bonuses" section). BonusGroups provides the registry once; each BonusSetForm instance
