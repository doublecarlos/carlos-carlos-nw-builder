...
// `collapsed` -- and each knows only its own field. Before the merge, whichever saved last
// erased the other's preference, which is the kind of bug that only shows up as "my sections
// keep reopening" a session later.
